...
router.post("/follow", async (req,res) => {
    try {
        await Users.findByIdAndUpdate(req.body.userId, {$push: {following: req.body.followId}});
        try {
...
router.post("/unfollow", async (req,res) => {
    try {
        await Users.findByIdAndUpdate(req.body.userId, {$pull: {following: req.body.unfollowId}}) 
        try {
            let result = await Users.findByIdAndUpdate(req.body.unfollowId, {$pull: {followers: req.body.userId}})
            res.json(result)
        } catch(err) {
